...
@Component({
  ...
  standalone: true,
  imports: [RouterLink, IconComponent, StatusBadgeComponent, EmptyComponent, LoadingComponent, ModalComponent, FilePickerComponent, TPipe, NumPipe, ShortDatePipe],
...
export class ModelDetailComponent {
  ...
  readonly fileItems = computed<FilePickerItem[]>(() =>
    (this.model()?.files ?? []).map((f) => ({
      id: f.id,
      name: f.name,
      url: f.url,
      mime: f.mime,
